...
```sh 
git clone https://github.com/gtkwave/gtkwave/ gtkwave_code
cd gtkwave_code/
ls
meson setup build --prefix=$HOME/gtkwave
meson compile -C build
meson install -C build
../gtkwave/bin/gtkwave -h
../gtkwave/bin/gtkwave -V
#编辑.bashrc 文件添加环境变量
vim ~/.bashrc
export GTKWAVE_HOWE=$HOME/gtkwave
export PATH=$GTKWAVE_HOWE/bin:$PATH
export LD_LIBRARY_PATH=$GTKWAVE_HOME/lib:$GTKWAVE_HOME/lib64:$LD_LIBRARY_PATH
